...
public class ChessGame {
    ...
    public static void main(String[] args) throws IOException {
       //path of the image used
        BufferedImage all=ImageIO.read(new File("C:\\Users\\Nkunzi\\OneDrive\\Documents\\NetBeansProjects\\ChessGame\\chess.png"));
       ...
       ind++;
        ...
        public void paint(Graphics g){
            //sets the color of the chess board
        boolean white = true;
        for(int y = 0;y<8;y++){
        for(int x = 0;x<8;x++){
            if(white){
            g.setColor(new Color(25,25,208));
            }else{
        ...
        for(Piece p: ps){
                    ...
                    //draws the piece on the position it is on
        ...
        frame.addMouseMotionListener(new MouseMotionListener() {
            @Override
            //allows the mouse to drag the piece
        ...
        frame.addMouseListener(new MouseListener() {
            ...
            public void mouseReleased(MouseEvent e) {
                //moves the selected piece and repaints it dependening if it kills or not
